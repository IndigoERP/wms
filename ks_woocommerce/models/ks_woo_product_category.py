...
class KsModelProductCategory(models.Model):
    ...
    def ks_woo_post_category(self, data, instance):
        """
        ...
        try:
            ...
            if all_category:
                ...
                for index, data in enumerate(all_category):
                    ...
                    if layer_category:
                        try:
                            odoo_main_data = self.ks_map_product_category_data_for_odoo(data)
    ...
    def ks_manage_category_export(self, queue_record=False):
        """
    ...
    def ks_map_product_category_data_for_odoo(self, json_data):
        """
